...
// Creates JSON formatted meshmodel attribute item for Meshplay docs
func (t TemplateAttributes) CreateJSONItem() string {
	...
	json += fmt.Sprintf(",\"permaLink\":\"https://docs.khulnasoft.com/integrations/%s\"", FormatName(t.Title))
