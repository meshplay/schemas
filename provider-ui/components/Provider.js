...
import { CustomDiv, CustomDialog, MeshplayLogo, MenuProviderDisabled, CustomDialogActions, LearnMore } from "./Provider.style";
      ...
      >
        ...
        <DialogContent dividers>
          <DialogContentText id="customized-dialog-content">
                        Login to Meshplay by choosing from the available providers. Providers extend Meshplay by offering various plugins and services, including identity services, long-term persistence, advanced performance analysis,  multi-player user collaboration, and so on.
        ...
        <CustomDialogActions>
          <div className="learnmore">
            <a href="https://docs.khulnasoft.com/extensibility/providers">Providers in Meshplay Docs</a><img src={externalLinkIcon} width="16px" />
          </div>
          <Button
