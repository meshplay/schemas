...
#   get_tag_keys("annotations") := {"khulnasoft.com/namespace", "khulnasoft.com/service"} for input {"annotations": {"khulnasoft.com/namespace": "default", "khulnasoft.com/service": "redis"}}
