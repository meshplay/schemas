...
<p>Participating service mesh projects can also <a href="{{ site.baseurl }}/tasks/service-mesh-interface#reporting-conformance">automatically report their conformance test results</a> to the <a href="https://khulnasoft.com/service-mesh-interface">SMI Conformance dashboard</a></p>
</details>