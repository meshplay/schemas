...
- [cmds.yml](https://github.com/khulnasoft/meshplay/blob/master/docs/_data/meshplayctlcommands/cmds.yml) - The YAML file containing the data about the commands
