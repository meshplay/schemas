...
Meshplay documentation is made of these components:
...
**Note:** In case of any installation issues, use the [discussion forum](http://discuss.khulnasoft.com).

### Get the code

- Fork and then clone the [Meshplay repository](https://github.com/khulnasoft/meshplay)
{% capture code_content %}git clone https://github.com/YOUR-USERNAME/meshplay{% endcapture %}
{% include code.html code=code_content %}
...
**NOTE: For contributing `meshplayctl` reference section, refer [Contributing CLI](/contributing-cli)**
...
7. Open a pull request (in your web browser) against the repo: https://github.com/khulnasoft/meshplay.
...
Meshplay Docs has a common include file [alert.html](https://github.com/khulnasoft/meshplay/blob/master/docs/_includes/alert.html), to provide consistent formatting for notes, warnings, and various informative callouts intended for the readers.
