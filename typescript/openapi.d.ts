...
export interface components {
    schemas: {
        ...
        /** @description Components are reusable building blocks for depicting capabilities defined within models. Learn more at https://docs.meshplay.io/concepts/components */
        component: {
            /** @description Uniquely identifies the entity (i.e. component) as defined in a declaration (i.e. design). */
            id?: components["schemas"]["uuid"];
        ...
        selector: {
            kind?: string;
            /** @description Name of the model implicated by this selector. Learn more at https://docs.meshplay.io/concepts/models */
            model?: components["schemas"]["model"];
            id?: components["schemas"]["uuid"];
        ...
        relationship: {
            ...
            model: components["schemas"]["model"];
            /**
             * @description Kind of the Relationship. Learn more about relationships - https://docs.meshplay.io/concepts/logical/relationships.
             * @enum {unknown}
             */
            kind: components["schemas"]["inputString"];
